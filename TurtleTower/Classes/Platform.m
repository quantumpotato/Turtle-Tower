...
-(id)init{
	if (self = [super init]){
		self.view = [[UIView alloc] initWithFrame:CGRectMake(-300,10,10,10)];
		...
		self.secondView = [[UIView alloc] initWithFrame:CGRectMake(-300,10,10,10)];
